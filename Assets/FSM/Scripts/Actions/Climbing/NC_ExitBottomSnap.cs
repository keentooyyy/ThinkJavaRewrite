...
public class NC_ExitBottomSnap : ActionTask<Transform>
{
    public BBParameter<bool> isClimbing;
    public BBParameter<bool> lockToLadderX;
    public float placeBelow = 0.05f;
    ...
    protected override void OnExecute()
    {
        ...
        float targetY = _sensor != null ? _sensor.LadderBottomY() - placeBelow : agent.position.y;
